...
public class ExtContextBase extends FREContext {
    ...
    public void onResume() {
        dispatchStatusEventAsync("onResume", "");
    }

    public void onPause() {
        dispatchStatusEventAsync("onPause", "");
    }

    public void onDestroy() {
        dispatchStatusEventAsync("onDestroy", "");
    }

    public void onStart() {
        dispatchStatusEventAsync("onStart", "");
    }

    public void onStop() {
        dispatchStatusEventAsync("onStop", "");
    }

    public void onBackPressed() {
        dispatchStatusEventAsync("onBackPressed", "");
    }
}
